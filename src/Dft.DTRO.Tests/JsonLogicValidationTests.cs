...
{
    private readonly Mock<IJsonLogicRuleSource> ruleSource = new();
        ...
        var dtro = PrepareDtro(@"
{
    ...
    public async Task AllowExternalReferenceLastUpdateDateInThePast()
    {
        ...
        JsonLogicValidationService sut = new JsonLogicValidationService(ruleSource.Object);
    ...
    public async Task AllowHeightCharacteristicValidForRegulationTypeDimensionMaximumHeightWithTro()
    {
        ...
        JsonLogicValidationService sut = new(ruleSource.Object);
        ...
        var dtro = PrepareDtro(@"
{
    ...
    private async Task UseRulesByIndex(params int[] indexes)
    {
        ...
        ruleSource.Setup(it => it.GetRules(It.IsAny<string>())).ReturnsAsync(selected);
    }
}
